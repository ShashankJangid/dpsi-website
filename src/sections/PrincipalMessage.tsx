      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <p className="text-base font-extrabold text-amber-300 tracking-tight drop-shadow-xs">{name}</p>
              <p className="text-xs font-semibold text-slate-100 mt-0.5">{title}</p>
            </motion.div>
          </motion.div>
